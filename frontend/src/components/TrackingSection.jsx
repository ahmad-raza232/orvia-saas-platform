    ...
    <section className="bg-olive py-20 text-peach" id="tracking">
      <Container className="max-w-3xl text-center">
        <SectionHeading
          ...
          description="Enter your Softorica ORVIA tracking ID, or a legacy GoBurq GBQ ID."
        ...
        <p className="mt-4 text-sm text-peach/70">
          Softorica: <span className="font-mono text-peach">ORVIA-XXXXXXXXXX</span>
          {' · '}
          Legacy: <span className="font-mono text-peach">GBQ…</span>
        </p>
      </Container>
    </section>
  );
